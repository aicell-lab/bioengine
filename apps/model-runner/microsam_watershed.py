# WORKAROUND(2026-08-23): vendored copy of ``bioimageio.core._ops_microsam``
# from https://github.com/bioimage-io/core-bioimage-io-python/pull/501
# (unmerged). model-runner keeps bioimageio.core pinned at 0.10.4, so the
# watershed that turns micro-SAM AIS decoder maps into instance labels is not
# importable from the library yet. Delete this file and import
# ``bioimageio.core.microsam_watershed`` once the PR is released.
